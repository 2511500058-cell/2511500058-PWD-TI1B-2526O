...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    /* validasi pid */
    $pid_post = filter_input(INPUT_POST, 'pid', FILTER_VALIDATE_INT, [
        'options' => ['min_range' => 1]
    ]);
    if (!$pid_post || $pid_post != $pid) {
        $_SESSION['flash_error'] = 'ID Tidak Valid.';
...
<section>
    <h2>Form Edit Biodata Pengunjung</h2>
    <form action="edit_biodatapengunjung.php?pid=<?= htmlspecialchars($pid); ?>" method="post">
