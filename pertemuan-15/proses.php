...
// Proses submit biodata mahasiswa
if (isset($_POST['submit_biodata'])) {
    ...
    // Query insert biodata
    $sql = "INSERT INTO tbl_biodatamhs (cnim, cnama, ctempat_lahir, dtanggal_lahir, chobi, cpasangan, cpekerjaan, cnama_ortu, cnama_kakak, cnama_adik) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
